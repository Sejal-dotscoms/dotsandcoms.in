...
function AboutPage() {
  useEffect(() => {
    ...
    return setPageSEO({
      ...
      description: "Learn about Dots & Coms, a web development company in Baroda with 19+ years of experience in website design, mobile app development, SEO, and web hosting.",
